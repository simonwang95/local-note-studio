...
5. 点击“授权并刷新 Cookie”。应用会先说明授权范围；随后 macOS 可能询问“访问其他 App 的数据”，并弹出 Chrome Safe Storage/钥匙串确认。这两项与读取所选 Profile 有关。刷新 Cookie 不需要“文稿”“下载”“网络宗卷”或“可移动宗卷”权限，出现时应拒绝并检查是否选错目录。
